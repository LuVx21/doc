...
- [MySQL配置的工作原理](#mysql配置的工作原理)
- [小心翼翼的配置MySQL](#小心翼翼的配置mysql)
    - [好习惯1：不要通过配置项的名称来推断一个变量的作用](#好习惯1不要通过配置项的名称来推断一个变量的作用)
    - [好习惯2：不要轻易在全局修改会话级别的配置](#好习惯2不要轻易在全局修改会话级别的配置)
    - [好习惯3：配置变量时，并不是值越大越好](#好习惯3配置变量时并不是值越大越好)
    - [好习惯4：规范注释，版本控制](#好习惯4规范注释版本控制)
    - [坏习惯1：根据一些“比率”来调优](#坏习惯1根据一些比率来调优)
    - [坏习惯2：随便使用调优脚本](#坏习惯2随便使用调优脚本)
- [给你一个基本的MySQL配置](#给你一个基本的mysql配置)
    - [分段](#分段)
    - [GENERAL](#general)
