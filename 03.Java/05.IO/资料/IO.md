...
- [史上最骚最全最详细的IO流教程, 没有之一!](#史上最骚最全最详细的io流教程-没有之一)
- [1, 告白IO流的四点明确](#1-告白io流的四点明确)
- [2, File类](#2-file类)
...
- [3, 初探IO流](#3-初探io流)
    ...
    - [2.2 字节输出流(OutputStream)](#22-字节输出流outputstream)
            ...
            - [FileOutputStream实现数据追加续写, 换行](#fileoutputstream实现数据追加续写-换行)
...
- [5, Properties属性类](#5-properties属性类)
...
直接上代码:
    ...
    public classCopyFile{
        ...
        public staticvoid copyMethod2(FileReader fr, FileWriter fw) throws IOException {
